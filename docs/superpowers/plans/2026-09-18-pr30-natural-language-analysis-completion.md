...
Implementation, scope audit, and fresh full-suite CI #649 are green. A documentation-only final-head CI must also remain green before PR30 is marked Ready for Review.
